    ...
    <div class="branch_wrap_cen">
        ...
        <div class="rightContent">
            ...
            <div class="item_syllabus_list">
                <div class="item_syllabus_list_tag" style="padding-left: 0">
                    ...
                    <c:if test="${courseStatus == 2}">
                        ...
                        <span class="item_syllabus_list_tag_lie"><a href="/course/group/status.action?courseStatus=2">已完成</a></span>
                    </c:if>
                </div>
            </div>
            ...
            <!-- 分页 开始 -->
				<div class="pager">
					<c:set var="pageUrl"
						value="/course/group/status.action?pageNo=pageno&courseStatus=${courseStatus }"
						scope="request" />
