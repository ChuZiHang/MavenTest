    ...
    <div class="branch_wrap_cen">
        ...
        <div class="rightContent">
            ...
            <div class="item_syllabus_list">
                <div class="item_syllabus_list_tag" style="padding-left: 0">
                    <span class="item_syllabus_list_tag_lie">
                        <a href="/course/group/status_bmz.action">报名中</a>
                    </span>
            ...
            <div class="member_item_table branch_shop_box ">
                <c:forEach items="${beanList}" var="bean" >
                <dl>
                    <a href="/course/group/toProDetail_bmz.action?id=${bean.id }" target="_blank">
                    ...
                    <dd class="syllabus_list_block">
                        ...
                        <p>
                            <em>${bean.cardName }</em>
                            <em><fmt:formatDate value="${bean.endTime }" pattern="yyyy-MM-dd"/></em>
                        </p>
                    </dd>
                    </a>
                </dl>
            ...
            <!-- 分页 开始 -->
				<div class="pager">
					<c:set var="pageUrl"
						value="/course/group/status_bmz.action?pageNo=pageno"
						scope="request" />
