		...
		<div class="branch_wrap_cen">
            ...
            <div class="busuness_title">
                <div class="member_detail_tag">
                    <span class="on"><em><a href="/account/business/report.action">日表</a></em></span>
                ...
                <div class="busuness_title_con">
                    ...
                    <span id="myDate"><fmt:formatDate value="${date }" pattern="yyyy年MM月dd日"/></span>
                    <input id="curDate" value="${date2 }" type="hidden">
                    <a href="/account/business/report.action"><div class="joinbusiness_today">今天</div></a>
            ...
            <div class="business_cont" style="overflow: scroll;">
				...
				<div class="pager">
					<c:set var="pageUrl"
						value="/account/business/report.action?pageNo=pageno&date=${date3 }&type=${type }&custId=${custId }"
						scope="request" />
...
$("#search").click(function(){
	...
	location.href="/account/business/report.action?type="+type+"&custId="+custId+"&date="+date1.toJSON();
});
//导出execel
$(".export").click(function(){
	...
	location.href="/account/business/export.action?type="+type+"&custId="+custId+"&date="+date1.toJSON();
});
</script>
<script type="text/javascript">
$(function() {
...
<script type="text/javascript">
	...
	$("#right").click(function(){
		...
		//console.log(fff);
		var preDate = new Date(fff.getTime() - 24*60*60*1000);  //前一天
