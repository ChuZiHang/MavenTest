		...
		<div class="branch_wrap_cen">
            ...
            <div class="busuness_title">
                <div class="member_detail_tag">
                    ...
                    <span  class="on"><em><a href="/account/business/report_month.action"">月表</a></em></span>
                    <span><em class="bordernone "><a href="/account/business/report_week.action">周表</a></em></span>
                </div>
                <div class="busuness_title_con">
                    ...
                    <span id="myDate"><fmt:formatDate value="${date }" pattern="yyyy年MM月"/></span>
                    <input id="curDate" value="${date }" type="hidden">
                    <a href="/account/business/report_month.action"><div class="joinbusiness_today">当月</div></a>
            ...
            <div class="business_cont" style="overflow: scroll;">
				...
				<div class="pager">
					<c:set var="pageUrl"
						value="/account/business/report_month.action?pageNo=pageno&date=${date3 }&type=${type }&custId=${custId }"
						scope="request" />
...
$("#search").click(function(){
	...
	location.href="/account/business/report_month.action?type="+type+"&custId="+custId+"&date="+date1.toJSON();
});
//导出execel
$(".export").click(function(){
	...
	//return;
	location.href="/account/business/export_month.action?type="+type+"&custId="+custId+"&date="+date1.toJSON();
});
</script>
<script type="text/javascript">
$(function() {
...
<script type="text/javascript">
	...
	var month = getMonthStartDate(y,m);
	
	var showDate = y+"年"+(m+1)+"月";
	...
	$("#right").click(function(){
	 ...
	 $("#left").click(function(){
		var curDate = $("#curDate").val();
		//console.log(curDate);
		var showDate = getNextMonth(curDate);
    ...
    function getPreMonth(date) {
    	var fff = new Date(Date.parse(date.replace(/-/g,   "/")));
        var year = fff.getFullYear();//年
		var month = fff.getMonth();//月
        ...
        fff.setYear(year2);
        fff.setMonth(month2);
        $("#curDate").val(fff.getFullYear()+"-"+(fff.getMonth()+1)+"-"+fff.getDate());
        //console.log(month2);
         if(month2 == 12){
        	month2 = 0;
        	year2 = year2 + 1;
