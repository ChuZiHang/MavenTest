...
<head lang="en">
	...
	<style>
	.create_syllabus_box,.push-syllabus{
		height:488px;
		margin-top:-244px;
	}
	</style>
        ...
        <div class="rightContent">
            ...
            <div class="item_syllabus_list">
                <div class="item_syllabus_list_tag">
                    <span class="item_syllabus_list_tag_lie">
                        <a href="/course/group.action">列表</a>
                    </span>
                    <div>
            ...
            <div class="item_syllabus_list_show branch_shop_box view_bigimg">
                <c:forEach items="${beanList}" var="bean" >
                <dl>
                    <a href="/course/group/toDetail.action?id=${bean.id }" target="_blank"> 
                    <dt><img src="${bean.signImg }" alt="${bean.courseName }"></dt>
                    <dd class="syllabus_list_block">
                        <div class="syllabus_name">${bean.courseName }</div>
                        <shiro:hasPermission name="course/group:publish">
	                        <div class="fabu">
	                            <a href="#" class="fabukecheng">发布课程</a>
	                        </div>
                        </shiro:hasPermission>
                    </dd>
                    <input id="people" type="hidden" value="${bean.peopleNum }">
                    <input id="sale" type="hidden" value="${bean.salePrice/100 }">
                    <input id="cla" type="hidden" value="${bean.classCount }">
                    <input id="sign" type="hidden" value="${bean.signImg }">
                    <input id="is" type="hidden" value="${bean.isRefund }">
                    <input id="f" type="hidden" value="${bean.fee/100 }">
                    <input id="m" type="hidden" value="${bean.proDesc }">
                    </a>
                </dl>
                </c:forEach>
            </div>
            <!-- 分页 开始 -->
				<div class="pager">
					<c:set var="pageUrl"
						value="/course/group.action?pageNo=pageno&type=${type}"
						scope="request" />
					<jsp:include flush="true" page="/include/pager.jsp" />
				</div>
			<!-- 分页 结束 -->
			<div class="btns-area">
				<shiro:hasPermission name="course/group:add">
					<a href="javascript:void(0)" class="create_syllabus">新建收费团课</a>
				</shiro:hasPermission>
			</div>
        </div>
    </div>
...
<div class="create_syllabus_box closebox" style="display: none">
    <h3 class="create_syllabus_title">新建收费团课</h3>
    <div id="testDiv">
    <div class="create_syllabus_cont">
        <form id="form1" action="/course/group/add.action" method="post">
        <ul>
            <li>
                <span class="create_syllabus_item_name">名称</span>
                <input id="courseName" name="courseName" type="text" class="create_syllabus_input wid320 "/>
            </li>
            <li>
                <span class="create_syllabus_item_name">限制人数</span>
                <input id="peopleNum" name="peopleNum" type="text" class="create_syllabus_input wid320"/>
            </li>
            <li>
                <span class="create_syllabus_item_name">价格</span>
                <input id="salePrice" name="salePrice" type="text" class="create_syllabus_input wid320"/>
            	<span>元/人</span>
            </li>
            <li>
                <span class="create_syllabus_item_name">课程次数</span>
                <input id="classCount" name="classCount" type="text" class="create_syllabus_input wid320"/>
            	<span>次</span>
            </li>
            <li style="height:100%; overflow: hidden;">
                <!-- <span class="create_syllabus_item_name">图片</span>
                <div id="preview" style="float: left;"></div>
                <input type="file" onchange="previewImage(this);upload(this);" style="border:none" /> -->
                <span class="create_syllabus_item_name">图片</span>
                <div id="view"></div>
	    		<div id="fine-uploader-manual-trigger" style="width:700px;"></div>
                <input id="signImg" name="signImg" value="" type="hidden">
            </li>
            <li>
                ...
                <div class="tuikuan">
                    <em><i rel="1"></i>是</em>
                    <em><i rel="2"></i>否</em>
                    <input id="isRefund" name="isRefund" value="" type="hidden">
                    <em class="poundage" style="display: none;">
                        退款手续费<input id="fee" name="fee" type="text" class="refund">%
                    </em>
                </div>
            </li>
            <li>
                <span class="create_syllabus_item_name">课程内容</span>
                <textarea id="elm1" name="elm1" class="xheditor" rows="12" cols="80" style="width:442px; height:90px;"></textarea>
    ...
    <div class="create_card_btn">
         ...
         <em id="submit" class="create_syllabus_fs">添加</em>
    </div>
</div>
<div class="push-syllabus closebox">
    ...
    <h3 class="create_syllabus_cont">
        ...
        <ul>
            <li>
                <span class="create_syllabus_item_name">名称</span>
                <input id="cardName" name="cardName" type="text" value="" class="create_syllabus_input">
            </li>
            <div class="create_syllabus_cont_style2">
                <div>
                    <span>限制人数</span><input id="peopleNum1" name="peopleNum" type="text" class="create_syllabus_input input60">
                </div>
                <div>
                    <span>价格</span><input id="salePrice1" name="salePrice" type="text" class="create_syllabus_input input60" style="width:50px">
                	<span>元/人</span>
                </div>
                <div>
                    <span>课程次数</span><input id="classCount1" name="classCount" type="text" class="create_syllabus_input input60" style="width:50px">
                	<span>次</span>
                </div>
            </div>
            ...
            <li style="height:100%; overflow: hidden;">
                ...
                <span class="create_syllabus_item_name">图片</span>
                <div id="preview1" style="float: left;"><img src="" alt=""/></div>
                <div id="view"></div>
	    		<div id="fine-uploader-manual-trigger1" style="width:700px;"></div>
                <input id="signImg1" name="signImg" value="" type="hidden">
            </li>
            <li>
                <span class="create_syllabus_item_name">支持退款</span>
                <div class="tuikuan">
            ...
            <li style="height: 100%;overflow: hidden;">
                ...
                <!--<div class="joinbusiness"> + </div>-->
            </li>
            <li>
                <span class="create_syllabus_item_name" title="课程内容">课程内容</span>
                <textarea id="elm11" name="elm1" class="xheditor" rows="12" cols="80" style="width:442px; height:90px;"></textarea>
            	<%@include file="/include/editor.jsp" %>
			    <script>
			    /** Simple customization with current options **/
		        $('#elm11').trumbowyg({
    ...
    <div class="create_card_btn">
         <em class="create_syllabus_qx close">取消</em>
         <em id="publish" class="create_syllabus_fs">发送</em>
    </div>
</div>
</body>

<script type="text/javascript">
var arr = new Array();//教练数组
// 自定义竖滚动条
$(function(){
    $('#testDiv').slimScroll({
        alwaysVisible: true
...
$(function() {
	...
	$(".fabukecheng").click(function(){
      ...
      //教练列表
        $.ajax({
			 ...
			 success:function(res) {
        		...
        		$('.joinbusiness').change(function(){ 
                    ...
                    var html = "<p id='"+id+"'>"+ name +"<i></i></p>";
                    $('.joinbusiness').before(html);
                    //console.log(arr);
                	$('.showcoach p i').on('click',function(){
        ...
        var people = $(this).parent().parent().parent().children('#people').val();
        var sale = $(this).parent().parent().parent().children('#sale').val();
        var cla = $(this).parent().parent().parent().children('#cla').val();
        var sign = $(this).parent().parent().parent().children('#sign').val();
        var is = $(this).parent().parent().parent().children('#is').val();
        var f = $(this).parent().parent().parent().children('#f').val();
        var m = $(this).parent().parent().parent().children('#m').val();
        
        $("#cardName").val($.trim(name));
        $("#peopleNum1").val(people);
        $("#salePrice1").val(sale);
        $("#classCount1").val(cla);
        $("#signImg1").val(sign);
        $("#preview1").children().attr('src',sign);
        if(is==1){
        	$("#yes").addClass("on").parent().siblings().find("i").removeClass("on");
        	$(".poundage").show();
        	$("#fee1").val(f);
        	$(".tuikuan").children("#isRefund").val(1);
        }else{
        	$("#no").addClass("on").parent().siblings().find("i").removeClass("on");
        	$(".tuikuan").children("#isRefund").val(0);
        }
        $("#elm11").val(m);
