...
(function (factory) {
	...
	Sortable.prototype = /** @lends Sortable.prototype */ {
		...
		_onDragStart: function (/**Event*/evt, /**boolean*/isTouch) {
			var fillSyllaItem = document.getElementById("fillsyllabusitem");
			fillSyllaItem.style.display = "none";
		...
		_onDragOver: function (/**Event*/evt) {
			...
			if (!_silent && activeGroup &&
				...
				if ((el.children.length === 0) || (el.children[0] === ghostEl) ||
					...
					var fillSylla = document.getElementById("fillsyllabus");
					dragEl.onclick=function(e){
						alert("fg")
						var fillSyllaItem = document.getElementById("fillsyllabusitem");
						...
						var Elent1 = this;
						var Evedelect = document.getElementById("Evedelect");
			...
			//var fillSyllaItem = document.getElementById("fillsyllabusitem");
			//fillSyllaItem.style.display = "block";
		},
			...
			if (evt) {
				...
				if (dragEl) {
					...
					if (rootEl !== dragEl.parentNode) {
						...
						$("#insertCId").val(dragEl.id);
						$("#insertDate").val(dragEl.parentNode.parentNode.childNodes[1].textContent);
						console.log(dragEl.id);
						console.log(dragEl.parentNode.parentNode.childNodes[1].textContent);
